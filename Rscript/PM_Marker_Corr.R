...
# Last update: 2017-02-21, Shi Huang, Zheng Sun, Xiaoquan Su
#################################################################
...
gmat<-data.matrix(g)
#---------------------------------------------------------------------
allmetadata<-read.table(metadata.filename,header=T,sep="\t",row.names=1); allmetadata<-allmetadata[order(rownames(allmetadata)),]
